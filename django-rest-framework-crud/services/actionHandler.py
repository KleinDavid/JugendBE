...
from services.actionParser import ActionParser
...
class ActionHandler:
    ...
    def __init__(self, action, session, data_service):
        self.serverResult = ServerResult()
        self.dataService = data_service
        self.action = action
        self.session = session
        self.actionParser = ActionParser(self.actionResultData, self.dataService)
